...
#export hdensity="0.2d0"  #  gr/cm^3
#./fort_tmatrix $hydro_type $fr $phaseID $temp $hdensity $axis_ratioID $rad1 $rad2 $nr $set_elID
#export hdensity="0.3d0"  #  gr/cm^3
#./fort_tmatrix $hydro_type $fr $phaseID $temp $hdensity $axis_ratioID $rad1 $rad2 $nr $set_elID
#export hdensity="0.4d0"  #  gr/cm^3
#./fort_tmatrix $hydro_type $fr $phaseID $temp $hdensity $axis_ratioID $rad1 $rad2 $nr $set_elID
#export hdensity="0.5d0"  #  gr/cm^3
#./fort_tmatrix $hydro_type $fr $phaseID $temp $hdensity $axis_ratioID $rad1 $rad2 $nr $set_elID
#export hdensity="0.6d0"  #  gr/cm^3
./fort_tmatrix $hydro_type $fr $phaseID $temp $hdensity $axis_ratioID $rad1 $rad2 $nr $set_elID
export hdensity="0.7d0"  #  gr/cm^3
./fort_tmatrix $hydro_type $fr $phaseID $temp $hdensity $axis_ratioID $rad1 $rad2 $nr $set_elID
export hdensity="0.8d0"  #  gr/cm^3
./fort_tmatrix $hydro_type $fr $phaseID $temp $hdensity $axis_ratioID $rad1 $rad2 $nr $set_elID
