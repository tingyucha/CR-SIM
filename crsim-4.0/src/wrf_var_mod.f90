...
!!  Apr    2020  :: M.O     Added MP_PHYSICS=80 for CM1 with morrison 2 mom
!!
!!  *DESCRIPTION* 
!!
...
real*8,Dimension(:,:,:,:),Allocatable      :: qnice   ! [1/kg] Ice  Number concentration
real*8,Dimension(:,:,:,:),Allocatable      :: qngraup ! [1/kg] Graupel  Number concentration
real*8,Dimension(:,:,:,:),Allocatable      :: qvgraup  ! [m3/kg] Graupel  Particle Volume
!
End Type wrf_var_mp38
!!!-- added by Cha
!!
...
!
!!! Added by Cha 2025/08/20 ---
subroutine allocate_wrf_var_mp38(str)
Implicit None
...
!
return
end subroutine allocate_wrf_var_mp38
!!!-- added by Cha
...
subroutine allocate_wrf_var_mp80(str)
Implicit None
...
!
!!! Added by Cha 2025/08/20 --
subroutine initialize_wrf_var_mp38(str)
Implicit None
Type(wrf_var_mp38),Intent(InOut)     :: str
ReaL*8,parameter                     :: m999=-999.d0     
!
...
!
return
end subroutine initialize_wrf_var_mp38
!!!-- added by Cha
...
!!
!!--Added by oue for CM1 Apr 2020
subroutine initialize_wrf_var_mp80(str)
Implicit None
Type(wrf_var_mp80),Intent(InOut)     :: str
ReaL*8,parameter                     :: m999=-999.d0     
!
...
!
return
end subroutine initialize_wrf_var_mp80
!!
...
!!--added by oue
!
subroutine deallocate_wrf_var_mp38(str)
Implicit None
Type(wrf_var_mp38),Intent(InOut)     :: str
!
Deallocate(str%qcloud)
...
!
return
end subroutine deallocate_wrf_var_mp38
!!--added by Cha
...
!!
!!- Added by oue for CM1 Apr 2020
subroutine deallocate_wrf_var_mp80(str)
Implicit None
Type(wrf_var_mp80),Intent(InOut)     :: str
!
Deallocate(str%qcloud)
...
!
return
end subroutine deallocate_wrf_var_mp80
!
!!
